...
INPUT_DIR="/eos/user/b/bdanzi/Merged_SnTv2/Remaining_files"
# Cartella dove salvare i file di output
OUTPUT_DIR="/eos/user/b/bdanzi/VH_score_outputDir_v2"
# Modello e variabili YAML
MODEL_DIR="models/VH_v2/dnn_VH_class_mva_train_nowp90/"
VARIABLES_YAML="models/VH_v2/variables_train_VH_Withmbb.yaml"
